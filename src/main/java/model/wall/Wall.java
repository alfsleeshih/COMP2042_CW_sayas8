...
public class Wall {
    ...
    /**
     * This method increases the game difficulty if the condition of the live score is dividable by 50 or equal to 100 is met.
     */
    private void increaseGameDifficulty() {
        if (scoreList.getLiveScore().getScore() % 50 == 0) {
            ball.increaseSpeed();
        }
        if (scoreList.getLiveScore().getScore() == 100) {

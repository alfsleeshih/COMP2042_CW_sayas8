...
public class HomeMenuPanel extends JComponent {
     ...
     * 
     * @param listenForExitButton  the class that implements action listener
     */
     ...
     * 
     * @param listenForInstructionButton  the class that implements action listener
     */
     ...
     * 
     * @param listenForHighScoresButton  the class that implements action listener
     */
